...
// AUTOMATION ENGINE IMPORT ✅ (Path Fixed for Server Structure)
const { initProfitScheduler } = require('./utils/profitScheduler');
...
// 1. CORE ROUTE IMPORTS (Paths Fixed: Removed /src/ as per server structure)
...
const webTrackingRoutes = require('./routes/webTrackingRoutes');
const sbuRoutes = require('./routes/sbuRoutes');
 ...
 */
app.use(cors({
    origin: "*", // Enables Cross-Origin requests from external platforms
    methods: ["GET", "POST", "PUT", "DELETE", "PATCH", "OPTIONS"],
    allowedHeaders: [
        "Content-Type", 
        "Authorization", 
